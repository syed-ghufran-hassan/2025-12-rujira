...
* Ghost Lending: Decentralized money market allowing users to deposit assets in lending vaults that can be borrowed by authorized smart contract, mainly the Credit Accounts.
